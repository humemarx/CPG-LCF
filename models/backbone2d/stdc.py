...
Software: VSCode
Date: 2023-07-17 03:49:08
LastEditors: husserl
LastEditTime: 2023-07-18 02:34:55
'''
...
class STDCModule(nn.Module):
    ...
    def __init__(self,
        ...
        conv_0 = ConvModule(
            in_channels, out_channels // 2, kernel_size=1, norm_type=norm_type)
...
class STDCNet(nn.Module):
        ...
        for strides in self.stage_strides:
            ...
            self.stages.append(
                self._make_stage(self.channels[idx], self.channels[idx + 1],
                                 strides, norm_type, act_type, bottleneck_type))
    ...
    def _make_stage(self, in_channels, out_channels, strides, norm_type,
                    act_type, bottleneck_type):
        layers = []
...
class STDCContextPathNet(nn.Module):
    ...
    def __init__(self,
        ...
        self.backbone = get_module(backbone_cfg)
        ...
        self.conv_avg = ConvModule(
            last_in_channels[0], out_channels, kernel_size=1, norm_type=norm_type)
